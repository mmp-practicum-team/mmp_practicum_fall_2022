...
| :---------: | :---: | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 08 сентября |  01   | <ul><li>Введение в Python</li></ul>                                                                 | [Введение в Python](Seminars/01-intro)                                                                                                                                                                                                                                     | Контест 1: [Введение в язык Python](https://contest.yandex.ru/contest/40070/enter/)                                           |
| 15 сентября |  02   | <ul><li>Организация кода в Python: функции, модули, классы</li><li>Итераторы и генераторы</li></ul> | [Функции, модули, классы. Итераторы и генераторы](Seminars/02-code-org/code-org.ipynb)                                                                                                                                                                                     | Контест 2: [Классы, генераторы](https://contest.yandex.ru/contest/40326/enter/)                                               |
...
| 29 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>KNN</li></ul>                                      | [Обработка изображений, KNN](Seminars/04-image-processing-and-KNN)                                                                                                                                                                                                                                                                                 | Задание 1: [Метрические алгоритмы классификации](Tasks/Task%2001/task_01.pdf)                                                 |
...
| 13 октября  |  06   | <ul><li>Основы ООП</li></ul>                                                                        | [Основы ООП](Seminars/06-classes)                                                                                                                                                                                                                                          | ＼(٥⁀▽⁀ )／                                                                                                                   |
| 20 октября  |  07   | <ul><li>Основы ООП</li></ul>                                                                        | [Проектирование кода](Seminars/07-oop)                                                                                                                                                                                                                                     | Контест 4: [Декораторы, итераторы, классы](https://contest.yandex.ru/contest/41754/enter/)                                    |
| 27 октября  |  08   | <ul><li>Введение в обработку текстов</li></ul>                                                      | <ul><li>[Конспект по логистической регрессии](Seminars/08-text-processing-and-logreg/linear_classifier.ipynb)</li><li>[Обработка текстов](Seminars/08-text-processing-and-logreg/text_processing.ipynb)</li></ul>                                                                                                                                  | Задание 2: [Градиентные методы обучения линейных моделей](Tasks/Task%2002/task_02.pdf)                                        |
...
|  10 ноября  |  10   | <ul><li>Виртуальные окружения и контейнеры</li></ul>                                                | [Виртуальные окружения и контейнеры](Seminars/10-environments)                                                                                                                                                                                                             | ＼(٥⁀▽⁀ )／                                                                                                                   |
|  17 ноября  |  11   | <ul><li>Основы веб-разработки (введение)</li></ul>                                                  | [Введение в основы веб-разработки](Seminars/11-webdev-intro)                                                                                                                                                                                                               | ＼(٥⁀▽⁀ )／                                                                                                                   |
|  24 ноября  |  12   | <ul><li>Flask</li></ul>                                                                             | [Пример Flask приложения](Seminars/12-flask)                                                                                                                                                                                                                                                                                                       | Задание 3: [Ансамбли алгоритмов. Веб-сервер. Композиции алгоритмов для решения задачи регрессии](Tasks/Task%2003/task_03.pdf) |
| 01 декабря  |  13   | <ul><li>Серверная разработка на Python (продолжение)</li></ul>                                      | [Серверная веб-разработка](Seminars/13-web-servers)                                                                                                                                                                                                                        | ＼(٥⁀▽⁀ )／                                                                                                                   |
| 08 декабря  |  14   | <ul><li>Ctypes</li></ul>                                                                            | [Ctypes](Seminars/14-ctypes)                                                                                                                                                                                                                                                                                                                                                   | ＼(٥⁀▽⁀ )／                                                                                                                   |
| 15 декабря  |  15   | <ul><li>Методы повышения эффективности</li></ul>                                                    | [Методы повышения эффективности](Seminars/15-efficiency/efficiency.ipynb)                                                                                                                                                                                                                                                                                                                                                   | ＼(٥⁀▽⁀ )／                                                                                                                   |
